...
from PySide6.QtWidgets import QWidget, QVBoxLayout, QLabel, QPushButton, QHBoxLayout,QFrame,QApplication
...
class Home(QFrame):
    def __init__(self):
        ...
        self.posture_watcher = FrontPostureAnalyzer()
    ...
    def init_ui(self):
        ...
        self.set_base_button.setStyleSheet(button_stylesheet)
